...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference("Partner.count") do
      post partners_url, params: { partner: { address: @partner.address, city: @partner.city, name: @partner.name } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { address: @partner.address, city: @partner.city, name: @partner.name } }
